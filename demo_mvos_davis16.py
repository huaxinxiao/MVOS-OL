...
save_root_prefix = '_'.join(['./results/davis-16-val/' + meta_model_name, str(n_meta_init), name_suffix])
...
for i in range(seq_numbers):
    ...
    # for i_iter in range(n_meta_updates):
    ...
    for j in range(1, cur_seq_range):
        ...
        img = load_image_label_davis16(img_file)
